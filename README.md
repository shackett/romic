...
And, check out romic's [pkgdown site](https://shackett.github.io/romic/index.html) for organized documentation. Older versions of romic are available on the [Calico Github](https://github.com/calico/romic).
